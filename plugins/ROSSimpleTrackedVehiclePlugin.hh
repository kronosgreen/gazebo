...
#ifndef GAZEBO_ROSSIMPLETRACKEDVEHICLEPLUGIN_HH
#define GAZEBO_ROSSIMPLETRACKEDVEHICLEPLUGIN_HH
...
namespace gazebo {
  ...
  class GZ_PLUGIN_VISIBLE ROSSimpleTrackedVehiclePlugin :
    public ROSTrackedVehiclePlugin
  {
    public: ROSSimpleTrackedVehiclePlugin() = default;

    public: virtual ~ROSSimpleTrackedVehiclePlugin();
    ...
    protected: void SetLeftTrackVelocityImpl(const std_msgs::Float64& _left) override;
    protected: void SetRightTrackVelocityImpl(const std_msgs::Float64& _right) override;
