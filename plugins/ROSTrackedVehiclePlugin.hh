 ...
 *
 */
#ifndef GAZEBO_PLUGINS_ROSTRACKEDVEHICLEPLUGIN_HH_
#define GAZEBO_PLUGINS_ROSTRACKEDVEHICLEPLUGIN_HH_
...
namespace gazebo
{
class ROSTrackedVehiclePluginPrivate;
...
class GZ_PLUGIN_VISIBLE ROSTrackedVehiclePlugin : public ModelPlugin
{
/// \brief Default Contstuctor
public: ROSTrackedVehiclePlugin();

/// \brief Destructor
public: virtual ~ROSTrackedVehiclePlugin();
...
protected: std::unique_ptr<ROSTrackedVehiclePluginPrivate> dataPtr;
...
/// \brief Tell controller to set velocity on ros msg
public: void OnRosMsg(const geometry_msgs::TwistStamped& _msg);
/// \brief If using individual tracks
public: void OnLeftTrackMsg(const std_msgs::Float64& _msg);
public: void OnRightTrackMsg(const std_msgs::Float64& _msg);

protected: virtual void SetLeftTrackVelocityImpl(const std_msgs::Float64& _left) = 0;
protected: virtual void SetRightTrackVelocityImpl(const std_msgs::Float64& _right) = 0;

/// \brief ok i actually don't know what this is doing
